module.exports = app => {
    ...
    router.get('/news/lnit', async(req, res) => {
        const parent = await Category.find().where({
            name: '新闻分类'
        })
        const carts = await Category.find().where({
            parent: parent,

        }).lean()
        const newsTitles = ["全民电竞一起拼，快手主播大神集结！", "狄某有话说 | 痛苦面具身上戴，下局别把装备卖", "“全民电竞”版本上线，王者荣耀拉满电竞“氛围感”！", "三街工作室丨如何塑造峡谷的玩法多样性", "王者荣耀全新玩法全民电竞即将上线，这个夏天趁热上场！", "7月24日边境突围模式玩法异常说明", "7月24日全服不停机更新公告", "7月23日体验服停机更新公告", "7月23日全服不停机更新公告", "7月23日全民电竞玩法礼包及任务奖励补充说明", "《热夏电竞日记》活动开启公告", "趁热上场，拼出高光活动开启公告", "“一”启幸运活动开启，概率得永久史诗皮肤", "无论何人皆赴赛场，活力夏季激情飞扬", "嫦娥源·梦皮肤海报票选结果公布", "王者荣耀全国大赛走进武汉，电竞与城市的命题究竟有多少解法?", "决胜江城，英雄出征——第三届王者荣耀全国大赛总决赛回顾", "全国大赛十大喝彩瞬间⑩：总决赛圆满落幕 携手武汉持续探索电竞新可能", "武汉斗鱼NBW斩获第三届王者荣耀全国大赛总冠军!第三届王者荣耀全国大赛总决赛战报", "第三届王者荣耀全国大赛行业合作颁奖典礼圆满落幕 四大奖项助推全民电竞"]
        const newsList = newsTitles.map(title => {
            const randomCtas = carts.slice(0).sort((a, b) => Math.random() - 0.5)
            return {
                categories: randomCtas.slice(0, 2),
                title: title
            }
        })
    ...
    router.get('/heroes/lint', async(req, res) => {
        await Hero.deleteMany({})
        const rawData = [{
                "name": "热门",
                "heroes": [
                    { "name": "鲁班七号", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/112/112.jpg" }, { "name": "妲己", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/109/109.jpg" }, { "name": "安琪拉", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/142/142.jpg" }, { "name": "瑶", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/505/505.jpg" }, { "name": "后羿", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/169/169.jpg" }, { "name": "马可波罗", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/132/132.jpg" }, { "name": "亚瑟", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/166/166.jpg" }, { "name": "铠", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/193/193.jpg" }, { "name": "吕布", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/123/123.jpg" }, { "name": "诸葛亮", "avatar": "https://game.gtimg.cn/images/yxzj/img201606/heroimg/190/190.jpg" }
                ]
            },
            {
                "name": "战士",
    ...
    router.get('/heroes/:id', async(req, res) => {
        const data = await Hero.findById(req.params.id)
            .populate("categories items1 items2 partners.hero  partners1.hero partners2.hero").lean()
        res.send(data)
    })
